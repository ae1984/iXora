 ...
 * CHANGES
        ...
        04/10/05 - rundoll проверка Сч.П и К.Сч на 9 знаков
*/
...
do trans :
 ...
 display
     remtrz.remtrz v-ref remtrz.rdt
     ...
     remtrz.bb[1]  remtrz.bn[1] remtrz.bn[2]
     dtt1 dtt2
     remtrz.ord remtrz.ordins[1] vpname 
     remtrz.bi  v-priory
     with frame remtrz .
...
&postupdate = "
    ...
    if ( avail que and que.con ne ""F"" and que.pid = m_pid
     ...
     and  m_pid ne ""3""  and  m_pid ne ""3W"" and u_pid ne ""inw_Icps""
        and m_pid ne ""NC"" and m_pid ne ""GW"")  then
        do: run rotlxzi .
         release remtrz.
         release que .
        end .
