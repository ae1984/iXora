...
i = 0.
for each sgnview where sgnview.whn >= v-dtb and sgnview.whn <= v-dte no-lock break by sgnview.whn by sgnview.bank by sgnview.tim:
  if v-bank <> "" and sgnview.bank <> v-bank then next.

  i = i + 1.

  find bookcod where bookcod.bookcod = "sgnres" and bookcod.code = sgnview.result no-lock no-error.
  if avail bookcod then v-res = bookcod.name.
                   else v-res = "".
  
  find t-cif where t-cif.cif = sgnview.cif no-lock no-error.
  find t-ofc where t-ofc.ofc = sgnview.who no-lock no-error.

  put unformatted 
    "<TR><TD>" i "</TD>" skip
      "<TD align=""center"">" string(sgnview.whn, "99/99/9999") "</TD>" skip
      "<TD align=""center"">" string(sgnview.tim, "HH:MM:SS") "</TD>" skip
      "<TD align=""center"">" sgnview.bank "</TD>" skip
      "<TD align=""center"">" sgnview.cif "</TD>" skip
      "<TD>" t-cif.name "</TD>" skip
      "<TD align=""center"">" sgnview.who "</TD>" skip
      "<TD>" t-ofc.name "</TD>" skip
      "<TD>" v-res "</TD>" skip
    "</TR>" skip.

  accumulate sgnview.cif (count by sgnview.whn by sgnview.bank).

  if last-of(sgnview.bank) then do:
    put unformatted 
      "<TR style=""font:bold"">" skip
        "<TD align=""right"" colspan=4>ИТОГО ПО БАНКУ " sgnview.bank "</TD>" skip
        "<TD align=""right"">" accum sub-count by sgnview.bank sgnview.cif "</TD>" skip
        "<TD></TD>" skip
        "<TD></TD>" skip
        "<TD></TD>" skip
        "<TD></TD>" skip
  ...
  if last-of(sgnview.whn) then do:
    put unformatted 
      "<TR style=""font:bold"">" skip
        "<TD align=""right"" colspan=4>ИТОГО ЗА ДАТУ " string(sgnview.whn, "99/99/9999") "</TD>" skip
        "<TD align=""right"">" accum sub-count by sgnview.whn sgnview.cif "</TD>" skip
        "<TD></TD>" skip
        "<TD></TD>" skip
        "<TD></TD>" skip
        "<TD></TD>" skip
...
put unformatted 
  "<TR style=""font:bold"">" skip
    ...
    "<TD align=""right"">" accum count sgnview.cif "</TD>" skip
    "<TD></TD>" skip
    "<TD></TD>" skip
    "<TD></TD>" skip
    "<TD></TD>" skip
