/* posjou.p
 * MODULE
        Выдача наличных через POS в Offline PragmaTX
 * DESCRIPTION
        Формирование joudoc для транзакций выдач наличных
 * RUN
...
joudoc.who     = g-ofc.
joudoc.tim     = time.
joudoc.drcur   = v-poscrc.
joudoc.crcur   = v-poscrc.
joudoc.jh      = s-jh.
joudoc.bas_amt = "D".
