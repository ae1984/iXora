...
find first b-bufdocs where b-bufdocs.contract = p-contract and (b-bufdocs.dntype = "02" or b-bufdocs.dntype = "03") no-lock no-error.
if avail b-bufdocs then v-max = b-bufdocs.numobyaz.
for each b-bufdocs where b-bufdocs.contract = p-contract and (b-bufdocs.dntype = "02" or b-bufdocs.dntype = "03") no-lock break by b-bufdocs.dndate:
...
for each vcdocs where vcdocs.contract = p-contract and (vcdocs.dntype = "02" or vcdocs.dntype = "03") no-lock:
    find first vcdocshismt where vcdocshismt.contract = p-contract and vcdocshismt.docs = vcdocs.docs and
