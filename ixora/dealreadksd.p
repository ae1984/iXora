...
on help of v-nin in frame deal do:
    ...
    displ v-nin v-cbname v-cbcrc v-atval v-type v-sort v-ncrc v-intrate v-base v-issuedt v-maturedt v-inttype
...
on help of v-deal in frame deal do:
    ...
    displ v-deal v-nin v-cbname v-cbcrc v-atval v-type v-sort v-ncrc v-intrate v-base v-issuedt v-maturedt /*v-paydt*/ v-ccrc v-inttype v-nomsum v-nkd v-ccrcsum v-dealsum v-yield /*v-closeprice v-closesum v-paydt*/
        with frame deal no-error.
end.
...
*/
    ...
    if cln then do:
        ...
        displ v-deal v-cif v-lsch v-nin v-cbname v-atval v-type
            ...
            v-base v-inttype v-col /*v-profit*/ v-ccrc v-cbcrc v-regdt
            v-valdt v-kontr v-dval2 v-dealsum /*v-bcrc v-closesum*/ v-nomsum v-nkd v-ccrcsum v-yield
    ...
    if not cln then do:
        ...
        displ v-deal v-scugrp v-nin v-cbname v-atval v-type v-sort v-ncrc v-intrate v-issuedt v-maturedt
            /*v-paydt*/ v-base v-inttype v-col /*v-profit*/ v-yield v-ccrc v-cbcrc v-regdt v-valdt v-kontr v-dval2 /*v-closesum v-closeprice*/
            v-dealsum v-ccrcsum v-nomsum v-nkd /*v-bcrc*/ v-geo v-sector with frame deal no-error.
