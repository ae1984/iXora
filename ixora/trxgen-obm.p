 ...
 * CHANGES
        ...
        23/05/2012 Luiza  - добавила рассылку в деп казначейства, если операции с 185800 и внебал превышают лимиты
...
run trxgen0-obm(trxcode, vdel, vparam, vsub, vref, output rcode
