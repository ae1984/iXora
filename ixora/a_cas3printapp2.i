 ...
 * DESCRIPTION
        Описание - 3. Внутренние переводы (В иностранной валюте)
 * RUN
...
repeat:
    ...
    repeat:
        ...
        if v-str matches "*bankbenficir*" then do:
            v-str = replace (v-str,"bankbenficir","").
            next.
        end.
        if v-str matches "*bikbenficiry*" then do:
            v-str = replace (v-str,"bikbenficiry","").
            next.
        end.
        ...
        if v-str matches "*accnumbe*" then do:
            v-str = replace (v-str,"accnumbe","").
            next.
        end.
        if v-str matches "*bankkorr*" then do:
            v-str = replace (v-str,"bankkorr","").
            next.
        end.
        ...
        if v-str matches "*bankorrbik*" then do:
            v-str = replace (v-str,"bankorrbik","").
            next.
        end.
