...
if v-tp = 1 then
    put unformatted  "<P align=""center"" style=""font:bold;font-size:small"">ОТЧЁТ ПО ОТКРЫТЫМ СЧЕТАМ ФИЗИЧЕСКИХ ЛИЦ C " + string(v-dbeg) + "  ПО " + string(v-dend) +  " </P>" skip.
else
    put unformatted  "<P align=""center"" style=""font:bold;font-size:small"">ОТЧЁТ ПО ОТКРЫТЫМ СЧЕТАМ ЮРИДИЧЕСКИХ ЛИЦ C " + string(v-dbeg) + "  ПО " + string(v-dend) +  " </P>" skip.
    ...
    for each txb where txb.consolid = true  no-lock:
        ...
        put unformatted  "<P align=""center"" style=""font:bold;font-size:small"">" + txb.info  skip.
        put unformatted "<TABLE cellspacing=""0"" cellpadding=""0"" align=""center"" border=""1"" width=""20%"">" skip.
