...
define var voldint like jl.dam.
define var vnewint like jl.dam.
define var vsavint like jl.dam.
define var vtotaip like jl.dam.
define var vintch  like jl.dam.
define var vln as int initial 1.
define var vcnt as int.
define var vytd like jl.dam.
...
find aaa using aaa.aaa.
    find lgr of aaa.
  /* prompt-for vytd label "INT PD YTD".
    aaa.cr[2] = - aaa.cr[2].   */
    voldacc = aaa.accrued.
    voldint = aaa.accrued.
    vsavint = aaa.accrued.
