...
form translat.nomer        colon 26 label 'Контрольный N перевода'  translat.jh          colon 60 format "zzzzzzzz9" label "N проводки"         skip     
     ...
     with row 3 side-labels centered width 110 frame translatch.

on help of translat.nomer in frame translatch do:
    run h-change.
    translat.nomer:screen-value = return-value.
end. 

on help of translat.crc-cash in frame translatch do:
    run h-crc.
