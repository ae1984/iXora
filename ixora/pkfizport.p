 ...
 * BASES
        BANK COMM
 * CHANGES
        01/10/2009 galina - исправила наименование выходного файла
*/
...
vfname = "/data/reports/push/bmkb/" + "pkfizport" + "-" + string(vyear) + "-" + string(vmont) + "-" + string(vquar) + "-" + string(vdate) + ".html".          
