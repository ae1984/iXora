 ...
 * DESCRIPTION
        Процедура принятия платежей Астана Энерго Сбыт в г. Астана - список
 * RUN
...
def browse b1
    ...
    display 
        ...
        with 14 down title "АстанаЭнергоСбыт" no-labels. 
...
ON CHOOSE OF bedt IN FRAME f1
    do:
        run ensin (dat, false, rowid(commonpl)).              
        b1:refresh().
    end.
...
ON CHOOSE OF bdel IN FRAME f1 do:
    ...
    MESSAGE "Удалить?"
       ...
       TITLE "АстанаЭнергоСбыт" UPDATE choice as logical.
        case choice:
