...
form
     ...
     tarif2.pakalp  format "x(30)" column-label "Услуга"
     tarif2.crc format "99" column-label "Вал"
      validate (can-find(crc where crc.crc = tarif2.crc),
               "Валюта не найдена ")
     tarif2.ost  validate(tarif2.ost >= 0," >=0 !") format "zzzz9.99"
      column-label 'Сумма'
     ...
     with overlay   column 1 row 5 13 down frame tarif2 .
