...
r1 = "Кредиты по субъектам кредитования".
...
create lnpr.
 lnpr.id = 1.
 lnpr.kname = "Кредиты ФЛ субъектам МСБ".
create lnpr.
 lnpr.id = 2.
 lnpr.kname = "Кредиты ФЛ за исключением субъектов МСБ".
create lnpr.
 lnpr.id = 3.
 lnpr.kname = "Кредиты ЮЛ субъектам МСБ".
create lnpr.
 lnpr.id = 4.
 lnpr.kname = "Кредиты ЮЛ за исключением субъектов МСБ".

find first cmp no-lock no-error.
if avail cmp then vcode = cmp.code.
{r-branch.i &proc = "afn_rpt6f(comm.txb.bank)"}


def var h1 as char no-undo.
def var h2 as char no-undo.
def var h3 as char no-undo.
h1 = "Размещение кредитных денег".
h2 = "Сумма".
h3 = "Удельный вес".
