...
vval = 0.
for each lnsci where lnsci.lni = s-lon and lnsci.flp = 0 
...
&addcon = "false"
&start = " "
&display = "lnsci.mark lnsci.schn lnsci.idat lnsci.iv lnsci.paid-iv"
&postdisplay = " "
&postadd = " "
&postkey = "else if lastkey = 510 then do:
             ...
             if lnsci.mark = """" then do:
                ...
                disp lnsci.mark with frame lonstl-i1.
...
&end = "hide frame msgi1. hide frame marked. leave upper."
}
end. /* upper */
