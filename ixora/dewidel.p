 ...
 * AUTHOR
        31/12/99 pragma
 * CHANGES
        19/04/2005 madiyar - добавил вывод в выписку штрафов и комиссий, в связи с этим небольшие изменения
        06/10/2006 madiyar - добавил еще одну строчку в деталях платежа
...
define variable sakbal as character initial "Входящий остаток по осн. долгу".
    ...
    new_page = no.
     ...
     /* ........................... */
       ...
       if deals.dc = "c" then do:
        ...
        if deals.trxcode = "PEN" then do:
          /*
          message dealsdet[1] view-as alert-box buttons ok.
          message dealsdet[2] view-as alert-box buttons ok.
          message bankinfo[1] view-as alert-box buttons ok.
          message bankinfo[2] view-as alert-box buttons ok.
          */
          bankinfo[1] = ''. bankinfo[2] = ''.
        end.
