 ...
 * DESCRIPTION
        Смена статуса транзакции для проводок пласт карт (аналогично 9-4)
 * RUN
...
if available jh  then do:
     ...
     message 
       ' Проводка не относится к Деп-ту Пласт Карт. Для смены статуса проводки см. п.9-4' view-as alert-box.
         leave.
     end.
