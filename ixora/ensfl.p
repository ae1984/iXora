 ...
 * DESCRIPTION
        Формирование и отправка информации по почте по платежам Астана Энерго Сбыт
 * RUN
...
put stream s2 unformatted space(6) "Список файлов для передачи в АстанаЭнергоСбыт за " + string(dt1,"99.99.9999") + crlf + crlf
...
MESSAGE "Отправить файлы в АстанаЭнергоСбыт по e-mail ?" +
...
TITLE "Внимание" UPDATE choiceout.
         ...
         case choiceout:
            ...
            when true  then run mail("municipal" + comm-txb() + "@elexnet.kz","bektasova@aes.kz",  
                                     "TEXAKABANK <apbk@elexnet.kz>",
                                     "Платежи АстанаЭнергоСбыт за " + string(day(dt1),'99.') + 
