 ...
 * Изменения
     ...
     11.08.2006 dpuchkov убрал биллинговые платежи в другой реестр. 
     09.10.2006 u00124 - Добавил сумму, комиссию, итого в реестре.
*/
...
if available tcommpl then do:
  ...
  "                         РЕЕСТР" skip
  "извещений по приему платежей за услуги связи " + commonls.bn skip(1)
