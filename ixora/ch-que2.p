...
def frame vv
     ...
     v-date  format "99/99/99"  label " Дата                    "  skip
...
update v-date format '99/99/99'
    label " Дата                    "  skip
    with side-label row 5 centered frame vv.

if v-date < g-today then do: 
   message "Неверная дата" view-as alert-box.
   undo, retry.
end.
