...
on choose of bt_AddNew in frame a2 do:
   ...
   if avail aaa then do:
      ...
      aas.whn = g-today.
      update aas.regdt aas.docnum aas.docdat aas.bnf /*aas.nkbin*/ aas.payee with frame getlist1.
   ...
   ON CHOOSE OF bprint IN frame fr1 do:
      ...
      if v-dep = 1 then do:
          for each aas where aas.sta = v-sta and aas.aaa = s_FindAcc and aas.ln <> 7777777 use-index aaaln:
              ...
              put unformatted "  " aas.cif " " b-cif.sname format 'x(20)' string(aas.regdt,"99/99/99") "  " aas.aaa format "x(20)" " " aas.docnum format 'x(7)' "  " string(aas.docdat,"99/99/99") "   " aas.nkbin format 'x(15)'  "   " aas.payee  skip.
          end.
      end.
      if v-dep = 2 then do:
