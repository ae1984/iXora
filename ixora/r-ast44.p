 ...
 * AUTHOR
        31/12/99 pragma
 * CHANGES
        11.05.2010 marinav - консолидация
        13.04.2012 damir   - изменил формат с "yes/no" на "да/нет".
        25/04/2012 evseev  - rebranding. Название банка из sysc.
        27.04.2012 damir   - передаваемая процедура передаваемая в r-brfilial.i, была указана с расширением *.p, убрал.
...
def var vop as log format "да/нет" init "yes".
...
{r-brfilial.i &proc = " r-ast442(vmc1,vmc2,v-fag,v-gl,v-ast,vib,vibk,vop) "}
