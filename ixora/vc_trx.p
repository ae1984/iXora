...
for each ock where ock.csts eq "R" and ock.ctype eq "VC" and ock.spby eq paka
...
if ock.aaa eq "" then do:
    ...
    for each ock where ock.csts eq "R" and ock.ctype eq "VC" and 
