...
for each txb.lon no-lock:
  ...
  if avail txb.lonstat then do:
   if txb.lonstat.lonstat = 1 then vid = 1.
   if txb.lonstat.lonstat = 2 then vid = 3.
   if txb.lonstat.lonstat = 3 then vid = 4.
   if txb.lonstat.lonstat = 4 then vid = 5.
   if txb.lonstat.lonstat = 5 then vid = 6.
   if txb.lonstat.lonstat = 6 then vid = 7.
   if txb.lonstat.lonstat = 7 then vid = 8.
  end. else vdl = 1.
