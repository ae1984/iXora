 ...
 * CHANGES
        ...
        18.08.2004 madiyar  - проверка правильности ввода менеджером запрашиваемой суммы
        20/05/2005 madiyar  - пока жестко прописал минимум суммы кредита для Алматы
        27/08/2005 madiyar  - миллион на 3 года (Алматы)
        31/08/2005 madiyar  - миллион на 3 года (Алматы) - изменения в расчете сумм
        01/09/2005 madiyar  - миллион на 3 года (Алматы) - убрал перерасчет срока v-srmin
        21/11/2005 madiyar  - максимальная сумма кредита в Актобе - 750000
        26/12/2005 madiyar  - округление максимальной суммы для срока
...
if avail pksysc then do:
    ...
    message skip " Не найден справочник anksum! " skip(1) view-as alert-box buttons ok .
    return.
end.
...
if avail pksysc then do:
    ...
    message skip " Не найден справочник anksrk! " skip(1) view-as alert-box buttons ok .
    return.
end.
