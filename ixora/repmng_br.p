...
def stream rep_br.
 ...
 repname = "rep_br_" + replace(string(dt1,"99/99/9999"),"/","-") + "_" +  replace(string(dt2,"99/99/9999"),"/","-") + ".htm".
 output stream rep_br to value(repname).

put stream rep_br "<html><head><title>Управленческая отчетность - консолидированный отчет</title>" skip
...
if choice then do:
  ...
  input through value ( "scp -q /data/reports/uprav/rep_br_" + repname + " Administrator@`askhost`:c:/tmp/rep_br.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_" + repname + " Administrator@`askhost`:c:/tmp/rpt.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB01_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB01.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB02_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB02.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB03_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB03.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB04_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB04.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB05_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB05.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB06_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB06.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB07_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB07.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB08_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB08.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB09_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB09.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB10_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB10.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB11_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB11.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB12_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB12.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB13_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB13.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB14_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB14.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB15_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB15.htm" ) .
  input through value ( "scp -q /data/reports/uprav/rpt_TXB16_" + repname + " Administrator@`askhost`:c:/tmp/rpt_TXB16.htm" ) .
