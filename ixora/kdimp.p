 ...
 * DESCRIPTION
        Поставщики по валютным контрактам
 * RUN
...
&formname  = "pksysc"
&framename = "kdaffil24"
&where     = " kdaffil.kdcif = s-kdcif and kdaffil.code = '24' "

&addcon    = "(s-ourbank = kdcif.bank)"
&deletecon = "(s-ourbank = kdcif.bank)"
&precreate = " "
&postadd   = "    kdaffil.bank = s-ourbank. kdaffil.code = '24'. kdaffil.kdcif = s-kdcif. kdaffil.who = g-ofc. kdaffil.whn = g-today. 
                  update kdaffil.name kdaffil.res with frame kdaffil24 .
