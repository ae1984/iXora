 ...
 * CHANGES
     ...
     16.01.2012 damir - закомментировал, подписал имя где поставил в коммент.
     02/20/2012 lyubov - исправила выборку символов касcплана
     ...
     10/08/2012 id00810 - добавила обработку транзакций по пополнению счетов по ПК
