 ...
 * BASES
        BANK COMM
 * AUTHOR
        21.04.2011 aigul - вывод сотрудников у кого typ совпадает с рассылкой опорников, на основе sndlogin
 * CHANGES
...
do:
   ...
   then do:
      ...
      delete buf.
      close query q1.
      open query q1 for each ofcsend where ofcsend.typ = "oporn".
      browse b1:refresh().
   end.
end.
