...
def new shared var doctypegrp as integer.
def new shared var doccounter as integer.
...
on "return" of browse bt do:
   if not available tmp then leave.
   run pensin (today, false, tmp.rid, 0).
end.
