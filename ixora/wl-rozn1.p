 ...
 * AUTHOR
        25.09.2013 dmitriy. ТЗ 1975 - за основу взят Watch List
 * BASES
        BANK COMM TXB
 * CHANGES
...
for each txb.longrp where lookup(string(txb.longrp.longrp), "20,60,67,80,81,82,95,96,27,28,68,90,92,97") > 0 no-lock:
