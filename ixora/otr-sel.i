 ...
 * DESCRIPTION
        Формирование списка организаций для отправки Прочих платежей.
 * RUN
...
for each commonls where commonls.arp = "001076668" and commonls.visible = yes and commonls.txb = seltxb 
...
run sel('Выберите организацию',s-sel).
