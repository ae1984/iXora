 ...
 * CHANGES
        ...
        07/02/2012 Luiza  - добавила проставление кассплана для счета 100500
        09/02/2012 dmitriy - перекомпиляция в связи с изменением x-cash0.f
*/


/* x0-cont.p
   Ввод символа касплана
   изменения от 04.05.2001
   - приходные символы <= 270
   = расхолные >= 310 */
...
def var d-amt as dec.
def var c-amt as dec.
...
/* p-pjh = 84392242 .  */
 update p-pjh validate (can-find(jh where jh.jh eq p-pjh) /*or can-find(aah where aah.aah eq p-pjh)*/ ,"")  with frame qqq.
  clear frame cont.
...
&enderr = "
 ...
 "
&start = " "
&frame-phrase = " with centered 10 down "
&predisp = "
    find first jl where jl.jh = p-pjh and jl.ln = tcash.ln no-lock .
