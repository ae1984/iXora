 ...
 * CHANGES
        ...
        28/09/2010 madiyar - добавил сводный отчет
        ...
        28/03/2011 madiyar - запускалась временная программа pkklasso2_tst, исправил
*/
...
/*
def new shared var s-sel as integer no-undo.
s-sel = 0.
run sel2 ("(TEST) ВЫБЕРИТЕ:", " 1. Сформировать отчет | 2. Рассчитать ТОЛЬКО автом. критерии | 3. Заполнить все критерии ", output s-sel).
if s-sel < 1 or s-sel > 3 then return.
*/

{r-brfilial.i &proc = "pkklass2_tst"}
