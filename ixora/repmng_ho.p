 ...
 * CHANGES
        ...
        13.08.2013 damir - Внедрено Т.З. № 1182,1258,1257,1650. com_exp - (добавил CHF,AUD).
*/
...
def stream rep.
 ...
 repname = "rpt_" + replace(string(dt1,"99/99/9999"),"/","-") + "_" +  replace(string(dt2,"99/99/9999"),"/","-") + ".htm".
 output stream rep to value(repname).

/*output stream rep to rpt.htm.*/

put stream rep "<html><head><title>Управленческая отчетность - ЦО</title>" skip
