...
*/
/*message "casher96.p" view-as alert-box.*/
...
def var ppunum like point.point.
...
put stream v-out unformatted
    "<P align=left>Все неакцептованные кассовые операции. Пункт N  " ppunum "</P>" skip
