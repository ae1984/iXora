...
put stream m-out "<html><head><title>МЕТРОКОМБАНК</title>" 
...
put stream m-out unformatted
  ...
  "<P align=""left"" style=""font:bold;font-size:x-small"">ОТЧЕТ ОБ ИЗЪЯТИИ со счетов за период с " v-date1 " по " v-date2 "</P>" skip
...
put stream m-out unformatted
      "<TR align=""center"" style=""font:bold"">" skip
        ...
        "<TD>ИИК</TD>" skip
        "<TD>Валюта </TD>" skip
        "<TD>Сумма <br>изъятия</TD>" skip
        "<TD>Дата</TD>" skip
        "<TD>Банк <br>инициатор</TD>" skip
        "<TD>Банк <br>списания</TD>" skip
        "</TR>" skip.

for each filpayment where filpayment.whn >= v-date1 and filpayment.whn <= v-date2 and filpayment.type begins 'get' no-lock.
