 ...
 * MODULE
        Потреб. кредитование
 * DESCRIPTION
        Формирование доп. соглашения по реструктуризации/пролонгации - пролонгация с отсрочкой
 * RUN
...
put stream rep unformatted
    ...
    "<tr style=""FONT-SIZE: 9pt; FONT-FAMILY: 'Times New Roman CYR'""><td width=50%></td><td width=50% align=""right"">Регистрационный N 120</td></tr>" skip
...
put stream rep unformatted
    ", при этом срок пользования Кредитом по Договору продлевается до " + date2str(v-dtend) + " г.</P>" skip
    "</td></tr>" skip.
...
put stream rep unformatted
    ...
    "окончания отсрочки, указанной в п.1 настоящего Дополнительного соглашения.</P>" skip
    "</td></tr>" skip.
...
put stream rep unformatted
    "<tr style=""page-break-before:always;FONT-SIZE: 9pt; FONT-FAMILY: 'Times New Roman CYR'""><td width=50%></td><td width=50% align=""right"">Тіркеу N 120</td></tr>" skip
    "<tr style=""font:bold"" align=""center"">" skip
...
put stream rep unformatted
    " бойынша тґлем мерзімін ўзарту ўсынылады, бўл ретте Шарт бойынша несиені пайдалану мерзімі" + date2str_kz(1,v-dtend) + " дейін ўзартылады.</P>" skip
    "</td></tr>" skip.
...
put stream rep unformatted
    "<table border=1 cellpadding=0 cellspacing=0 width=100% style=""FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman CYR'"">" skip
    "<tr align=""center"" style=""FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman CYR'"">" skip
    "<td>Кїні</td>" skip
