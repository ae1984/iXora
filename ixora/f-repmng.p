...
for each comm.txb no-lock:
    ...
    if avail t-kritval then do:
        ...
        repname = "rpt_fact_" + comm.txb.bank + "_" + replace(string(dt1,"99/99/9999"),"/","-") + "_" +  replace(string(dt2,"99/99/9999"),"/","-") + ".htm".
        output stream rep to value(repname).
        /*output stream rep to value("rpt_" + comm.txb.bank + ".htm").*/
