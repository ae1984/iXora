...
/*        title ' Search: [A]mount,[R]eference,s[Q]n ---' +
        ' repeat [L]ast amount search ' overlay */ "
         &predisp = "find remtrz where remtrz.remtrz = que.remtrz
          ...
          with row 17 . pause 0  . */
          npp = trim( substring( remtrz.sqn,19,8 ))."

        &seldisp = "que.remtrz"
        &file = "que"
        &disp = "que.remtrz column-label ""Платеж""
         remtrz.ord format ""x(15)"" column-label ""Отпр.""
         remtrz.amt column-label ""Сумма платежа""
         npp format ""x(6)"" column-label ""Номер ПП""
