...
r1 = "Отчет по просрочке по филиалам".
...
{r-branch.i &proc = "afn_rpt14f(comm.txb.bank)"}
...
output stream repdvk to repdvk.htm.
  ...
  for each lnpr no-lock:
    ...
    "<td> Итого </td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string(vnsum1,'>>>>>>>>>>>>>9.99')),'.',',') "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string((vnsum1 / vnsum1) * 100,'>>>>>>>>>>>>>9.99')),'.',',') + "%" "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string(vnsum2,'>>>>>>>>>>>>>9.99')),'.',',') "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string((vnsum2 / vnsum2) * 100,'>>>>>>>>>>>>>9.99')),'.',',') + "%" "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string(vnsum3,'>>>>>>>>>>>>>9.99')),'.',',') "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string((vnsum3 / vnsum3) * 100,'>>>>>>>>>>>>>9.99')),'.',',') + "%" "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string(vnsum4,'>>>>>>>>>>>>>9.99')),'.',',') "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string((vnsum4 / vnsum4) * 100,'>>>>>>>>>>>>>9.99')),'.',',') + "%" "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string(vnsum5,'>>>>>>>>>>>>>9.99')),'.',',') "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string((vnsum5 / vnsum5) * 100,'>>>>>>>>>>>>>9.99')),'.',',') + "%" "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string(vnsum6,'>>>>>>>>>>>>>9.99')),'.',',') "</td>" skip.
    put stream repdvk unformatted
    "<td>" replace(trim(string((vnsum6 / vnsum6) * 100,'>>>>>>>>>>>>>9.99')),'.',',') + "%" "</td>" skip.
