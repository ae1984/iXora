...
if avail txb.cmp then v-bankn = txb.cmp.name.
else v-bankn = "".

define  variable v-gldate as date.

v-gldate = p-dt.

define           variable      i         as integer      no-undo.
define           variable      v-gl      as integer      no-undo.
...
define           variable      v-bal     as decimal      no-undo.
...
/*******************************************************************************************************/
function Igl return integer(input gl as integer, input v-lev as integer,input acc as character,input des as character, input sub as character, input v-crc as integer, input v-r as character, input v-cgr as character, input v-hs as character, input v-ddt as date).
...
for each b-trxbal  no-lock :
    ...
    do:         /* разбор по типам счетов */
        ...
        /*{700txb.i &gl=arp.gl}*/
        Igl(arp.gl, b-trxbal.lev ,b-trxbal.acc,txb.arp.des, b-trxbal.sub, b-trxbal.crc, v-r , v-cgr ,  v-hs , txb.arp.spdt).
    end.
    ...
    do:              /* основные средства */
        ...
        Igl(txb.ast.gl, b-trxbal.lev ,b-trxbal.acc,txb.ast.name, b-trxbal.sub, b-trxbal.crc, "1" , "4" ,  "1" , txb.ast.ldd).
    end.
    ...
    do:                /* клиентские счета */
        ...
        /*{700txb.i &gl=aaa.gl}*/
        Igl(aaa.gl, b-trxbal.lev ,b-trxbal.acc,txb.cif.name, b-trxbal.sub, b-trxbal.crc, v-r , v-cgr ,  v-hs , txb.aaa.expdt).
    ...
    do:              /* коррсчета */
        ...
        /*{700txb.i &gl=dfb.gl}*/
        Igl(dfb.gl, b-trxbal.lev ,b-trxbal.acc,txb.dfb.name, b-trxbal.sub, b-trxbal.crc, v-r , v-cgr ,  v-hs , txb.dfb.duedt ).
    end.
    ...
    do:      /* межбанковские депозиты и кредиты */
        ...
        /* {700txb.i &gl=fun.gl}*/
        Igl(fun.gl, b-trxbal.lev ,b-trxbal.acc,txb.fun.accrcv, b-trxbal.sub, b-trxbal.crc, v-r , v-cgr ,  v-hs , txb.fun.duedt ).
    end.
     ...
     */
        ...
        /* {700txb.i &gl=scu.gl}*/
        Igl(scu.gl, b-trxbal.lev ,b-trxbal.acc,"SCU", b-trxbal.sub, b-trxbal.crc, v-r , v-cgr ,  v-hs , txb.scu.duedt).
    end.
    ...
    do:                  /* ссудные счета */
        ...
        /*{700txb.i &gl=lon.gl}*/
        Igl(lon.gl, b-trxbal.lev ,b-trxbal.acc,txb.cif.name, b-trxbal.sub, b-trxbal.crc, v-r , v-cgr ,  v-hs, txb.lon.duedt ).
    end.
end.
output close.
