...
def input param Operation as char.  /*0-принят,1-выдан,2-возврат*/
...
run savelog( "UpayState", "cRequestData: Transfer=" + Transfer + ", Operation=" + Operation ).

/***********************************************************************************/
/*
def var FileName as char.
FileName = "/data/reports/upay/" + Transfer + "_" + STrx + "_" + Operation + ".log".
output to value(FileName).
put unformatted "Request = upay " + Transfer + " " + STrx + " " + Operation + "~n".
*/
input through value("upay -changestatus " + Transfer + " " + Operation).
repeat:
...
run savelog( "UpayState", "cResponseData: " + p-mess + ", Code=" + string(ret-val) ).
