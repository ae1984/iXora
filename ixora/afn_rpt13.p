...
create lnpr.
 lnpr.id = 1.
 lnpr.kname = "Стандартные (0%)".
create lnpr.
 lnpr.id = 2.
 lnpr.kname = "Сомнительные:".
create lnpr.
 lnpr.id = 3.
 lnpr.kname = "Сомнительные 1 категории (5%)".
create lnpr.
 lnpr.id = 4.
 lnpr.kname = "Сомнительные 2 категории (10%)".
create lnpr.
 lnpr.id = 5.
 lnpr.kname = "Сомнительные 3 категории (20%)".
create lnpr.
 lnpr.id = 6.
 lnpr.kname = "Сомнительные 4 категории (25%)".
create lnpr.
 lnpr.id = 7.
 lnpr.kname = "Сомнительные 5 категории (50%)".
create lnpr.
 lnpr.id = 8.
 lnpr.kname = "Безнадежные (100%)".

find first cmp no-lock no-error.
if avail cmp then vcode = cmp.code.
{r-branch.i &proc = "afn_rpt1f(comm.txb.bank)"}

def var h1 as char no-undo.
def var h2 as char no-undo.
def var h3 as char no-undo.
h1 = "Категорий кредитов".
h2 = "Сумма".
h3 = "Доля,%".
