...
/*  bank.que.con = "P".   */
    ...
    if shtbnk.remtrz.jh1 eq ? or shtbnk.remtrz.jh1 = 0 then return.
    if shtbnk.remtrz.jh1 ne ? then do:
        v-text = "REMOTE " + bank.remtrz.remtrz + " <- подтверждение . Найдена 1 проводка " + string(shtbnk.remtrz.jh1).
        run lgps.
        bank.que.dp = today.
        bank.que.tp = time.
        bank.que.con = "F".
