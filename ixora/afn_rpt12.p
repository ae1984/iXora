...
r1 = "Сведения о выданных кредитах".
...
do transaction:
     update v-date1 label 'ЗАДАЙТЕ ПЕРИОД С'
            ...
            with row 8 centered  side-label frame opt title r1 .
...
create lnpr.
 lnpr.id = 1.
 lnpr.kname = "Юридические лица".
create lnpr.
 lnpr.id = 2.
 lnpr.kname = "Физические лица".

{r-brfilial.i &proc = "afn_rpt12f"}
