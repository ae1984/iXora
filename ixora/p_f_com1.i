...
function p_f_com1 returns decimal ( sum as decimal, code as char).  
...
define var comchar as char.
    ...
    */
    ...
    trid = rowid(tarif2).
    if can-find(first tarif2 where num = "7" and pakalp = comchar and 
                rowid(tarif2) <> trid and tarif2.stat = 'r')
    then do:
        l1: for each tarif2 where num = "7" and pakalp = comchar and tarif2.stat = 'r':
