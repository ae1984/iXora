 ...
 * DESCRIPTION
        Транзакции по счету ГК 100500 - ЭК (сортировка по суммам)
 * RUN
 ...
 * BASES
        BANK COMM
 * CHANGES
        02.03.2012 damir - вывод формы в формате WORD (без возможности редактирования) Т.З. № 1256, добавил menu-prt.
        07.03.2012 damir - убрал keyord.i
        25.04.2012 damir - небольшие корректировки по выводу отчета в WORD.
