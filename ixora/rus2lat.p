...
run rus2lat(input v-org, output v-dest, output v-err).
...
run savelog( "rus2lat", "32. Начало....................... ").
run savelog( "rus2lat", v-org).
...
do i = 1 to length(v-org):
      case  asc(caps( substr(v-org,i,1) )) :
          ...
          when asc("Ё") then v-dest = v-dest + "YO".
          when asc("Ж") then v-dest = v-dest + "ZH".
          when asc("З") then v-dest = v-dest + "Z".
          when asc("И") then v-dest = v-dest + "I".
          when asc("Й") then v-dest = v-dest + "J".
          ...
          when asc("Х") then v-dest = v-dest + "KH".
          when asc("Ц") then v-dest = v-dest + "C".
          when asc("Ч") then v-dest = v-dest + "CH".
          when asc("Ш") then v-dest = v-dest + "SH".
          when asc("Щ") then v-dest = v-dest + "SCH".
          when asc("Ы") then v-dest = v-dest + "Y".
          when asc("Э") then v-dest = v-dest + "E".
          when asc("Ю") then v-dest = v-dest + "YU".
          when asc("Я") then v-dest = v-dest + "YA".

          when asc("&") then v-dest = v-dest + "AND".
          when asc("%") then v-dest = v-dest + "PCT".
          ...
          when asc("A") then v-dest = v-dest + "A".
          when asc("B") then v-dest = v-dest + "B".
          when asc("C") then v-dest = v-dest + "C".
          when asc("D") then v-dest = v-dest + "D".
          when asc("E") then v-dest = v-dest + "E".
          when asc("F") then v-dest = v-dest + "F".
          when asc("G") then v-dest = v-dest + "G".
          when asc("H") then v-dest = v-dest + "H".
          when asc("I") then v-dest = v-dest + "I".
          when asc("J") then v-dest = v-dest + "J".
          when asc("K") then v-dest = v-dest + "K".
          when asc("L") then v-dest = v-dest + "L".
          when asc("M") then v-dest = v-dest + "M".
          when asc("N") then v-dest = v-dest + "N".
          when asc("O") then v-dest = v-dest + "O".
          when asc("P") then v-dest = v-dest + "P".
          when asc("Q") then v-dest = v-dest + "Q".
          when asc("R") then v-dest = v-dest + "R".
          when asc("S") then v-dest = v-dest + "S".
          when asc("T") then v-dest = v-dest + "T".
          when asc("U") then v-dest = v-dest + "U".
          when asc("V") then v-dest = v-dest + "V".
          when asc("W") then v-dest = v-dest + "W".
          when asc("X") then v-dest = v-dest + "X".
          when asc("Y") then v-dest = v-dest + "Y".
          when asc("Z") then v-dest = v-dest + "Z".
...
run savelog( "rus2lat", v-dest).
run savelog( "rus2lat", string(v-err)).
run savelog( "rus2lat", "121. Конец....................... ").
