...
/*            find first txb.remtrz where txb.remtrz.remtrz = txb.jh.ref no-lock no-error.
     ...
     create t-report2.
            t-report2.amount = string(entry(9, v-str, "")).
             ...
             totalCount = totalCount + 1.
                      ...
                      find last tarif2 where tarif2.num + tarif2.kod eq entry(7, v-str, "") no-lock no-error.
                      if avail tarif2 then do:
                         t-report2.transactionType = tarif2.pakal.
                      end.
                      else
                         t-report2.transactionType = "Не определено" .
