...
mkdir /data/log/$1/
mkdir /data/savedb/$1/
mkdir /data/savedb/$1/bank/
mkdir /data/savedb/$1/bank/full/
mkdir /data/savedb/$1/alga/
mkdir /data/savedb/$1/alga/full/
...
chmod 0777 /data/savedb/$1/
chmod 0777 /data/savedb/$1/bank/
chmod 0777 /data/savedb/$1/bank/full/
chmod 0777 /data/savedb/$1/alga/
chmod 0777 /data/savedb/$1/alga/full/
...
#echo "Copying of the structured file /pragma/etalon/bank.st to /data/"$1"/bank.st"; 
#if [ -f /pragma/etalon/bank.st ]
#then
#	cp /pragma/etalon/bank.st /data/$1/bank.st
#	chmod 0777 /data/$1/bank.st
#	echo "Structured file is successfully copied to /data/"$1"/bank.st"
#else
#	echo "File /pragma/etalon/bank.st not exists"
#fi
#*************************************************************************
